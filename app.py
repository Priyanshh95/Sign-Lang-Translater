...
# import os
# import translator
# from generated_text import SentenceGenerator  # Import your generator class
...
#         # ISL Translation for the original sentence
#         isl_sentence = translator.main3(sentence)
